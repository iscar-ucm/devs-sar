...
public class UavControl extends Atomic {
    ...
    public Port<Double> ucO7 = new Port<>("uavStartTime");
    public Port<Uav> ucO8 = new Port<>("uavPath");
    ...
    public void lambda() {
        ...
        if (phaseIs("start")) {
            ...
            ucO7.addValue(myUav.getInitState().getTime());
            // update scenario time
            scenarioTime = myUav.getInitState().getTime();
