function varargout=shadedErrorBar2(x,y,errBar,caso,lineProps,transparent)
...
patchSaturation2=0.25; %How de-saturated or transparent to make patch
...
if transparent
    ...
    faceAlpha=1;
    patchColor2=col+(1-col)*(1-patchSaturation);
    set(gcf,'renderer','painters')
    patchColor=col+(1-col)*(1-patchSaturation2);
end
...
switch(caso)
    ...
    case 1,
     ...
     uE=y+errBar(1,:);
     lE=y-errBar(1,:);
     H.edge(3)=plot(x,lE,'-','color',edgeColor);
     H.edge(4)=plot(x,uE,'-','color',edgeColor);
    ...
    H.patch(2)=patch(xP,yP,1,'facecolor',patchColor2,...
              'edgecolor','none',...
              'facealpha',faceAlpha);
...
H.mainLine=plot(x,y,lineProps{:}); %1 punto por iteraccion
